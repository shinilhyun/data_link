...
<body>
<div style="width:400px; height: 100%; margin: 300px auto 0;">
	<img src="<c:url value='/resources/images/common/warning.png' />" width="116" height="106" />
	<p style="font-size: 30px; margin: 46px 0 28px 0">415 Error</p>
	<p class="title" style="margin: 0 0 60px 0">HTTP 415 Error / 지원되지 않는 미디어 유형입니다. </p>

...
<body>
<div style="width:475px; height: 100%; margin: 300px auto 0;">
	<img src="<c:url value='/resources/images/common/warning.png' />" width="116" height="106" />
	<p style="font-size: 30px; margin: 46px 0 28px 0">500 Error</p>
	<p class="title" style="margin: 0 0 60px 0">HTTP 500 Error / HTTP 500 Internal Server error.</p>
